    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollContainer} contentContainerStyle={styles.content}>
        ...
        <View style={styles.bodyMapContainer}>
          <View style={styles.bodyMap}>
            <View style={styles.bodyMapPlaceholder}>
              <Ionicons name="body" size={120} color={COLORS.primary} />
        ...
        <View style={styles.regionsContainer}>
          <Text style={styles.sectionTitle}>Regiões do Corpo</Text>
        ...
        <View style={styles.instructionsCard}>
          ...
          <View style={styles.instructionsContent}>
            ...
            <Text style={styles.instructionsText}>
              Toque em uma região do corpo para ver todos os pontos de acupuntura 
              disponíveis nessa área. Você também pode usar a busca para encontrar 
              pontos específicos.
            </Text>
          </View>
        </View>
