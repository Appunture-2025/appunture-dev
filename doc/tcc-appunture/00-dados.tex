...
A plataforma foi desenvolvida para Android, apresentando 16 visualizações vetoriais (SVG) organizadas por meridianos e vistas (frontal e posterior). O sistema oferece funcionalidades de busca, detalhes dos 361 pontos principais, e um assistente baseado em Inteligência Artificial para auxiliar na correlação entre sintomas e pontos.
...
\textit{Appunture} is an educational digital atlas designed to facilitate access to information about acupuncture points for students and professionals interested in the field. The Android application features a digital anatomical atlas with 16 vector views (SVG), organized by meridians. The system includes search functionalities, details of 361 main points, and an AI-based assistant to help correlate symptoms and points.
