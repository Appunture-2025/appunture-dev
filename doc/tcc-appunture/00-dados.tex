...
O \textit{Appunture} não substitui a formação profissional adequada nem o acompanhamento de profissionais qualificados, mas busca ser uma ferramenta complementar de apoio ao estudo e à consulta de informações sobre acupuntura.
} 

\newcommand{\PalavraschaveTexto}{Acupuntura; Educação em Saúde; Aplicativo Móvel; Atlas Digital; Medicina Tradicional Chinesa.}

% ----------------------------------------------------------
% ABSTRACT em Inglês
\newcommand{\AbstractTexto}{
\textit{Appunture} is an educational platform designed to facilitate access to information about acupuncture points for students and healthcare professionals. The platform features a digital anatomical atlas with 15 vector views (SVG), organized by meridians. The system includes search functionalities, details of 361 main points, and an AI-based assistant to help correlate symptoms and points.
...
\textit{Appunture} does not replace proper professional training, but aims to be a complementary tool to support learning and information lookup about acupuncture.
}

\newcommand{\KeywordsTexto}{Acupuncture; Health Education; Mobile Application; Digital Atlas; Traditional Chinese Medicine.}
...
\criarsigla{iOS}{iPhone Operating System}
