...
\subsection{Funcionamento Offline Completo}

O aplicativo móvel foi projetado com estratégia ``\textit{offline-first}'', garantindo que todas as funcionalidades principais funcionem independentemente da conectividade:
