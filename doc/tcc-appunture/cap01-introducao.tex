...
O \textit{Appunture} foi desenvolvido com arquitetura ``\textit{offline-first}'', permitindo o acesso aos dados mesmo sem conexão à internet, com sincronização automática quando online. Para auxiliar no posicionamento dos pontos sobre as imagens anatômicas, foi desenvolvida uma ferramenta interna de mapeamento. Um painel administrativo web permite a atualização dos conteúdos do sistema.
