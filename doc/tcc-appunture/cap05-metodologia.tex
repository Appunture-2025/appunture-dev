...
\begin{enumerate}
    ...
    \item Como usuário, desejo salvar pontos de acupuntura como favoritos, para acessá-los rapidamente em consultas futuras.
    \begin{itemize}
        \item Critérios de aceitação: Deve ser possível adicionar e remover pontos dos favoritos. Os favoritos devem sincronizar entre dispositivos quando online.
    \end{itemize}
...
\hline
10 & Banco de dados local (SQLite) + versionamento & Mobile & 4 & Alta \\
\hline
11 & Sistema de sincronização (favoritos) & Mobile/Backend & 6 & Alta \\
\hline
12 & Backend RESTful (Java Firestore + JWT) & Backend & 5 & Alta \\
\hline
13 & APIs REST para gestão de pontos e sintomas & Backend & 6 & Alta \\
\hline
14 & Ferramenta Point Mapper para coordenadas & Web & 3 & Média \\
\hline
15 & Controle de acesso por perfil (user/admin) & Backend & 3 & Alta \\
\hline
16 & Deploy e testes finais (Web Mobile) & Todas & 5 & Média \\
\hline
\end{tabular}
...
\hline
Sprint 6 & 10--11 & 10 & Favoritos, sincronização offline e online \\
\hline
